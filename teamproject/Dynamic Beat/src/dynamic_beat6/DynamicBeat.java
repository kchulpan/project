...
public class DynamicBeat extends JFrame{
	...
	private Image titleImage = new ImageIcon(Main.class.getResource("../images/canonDText.png")).getImage();
	
	private Image selectedImage =new ImageIcon(Main.class.getResource("../images/canonDIntro.png")).getImage();
	...
	public DynamicBeat() {
		...
		startButton.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				introMusic.close();
				Music selectedMusic = new Music("BanYaCanonD.mp3", true);
				selectedMusic.start();

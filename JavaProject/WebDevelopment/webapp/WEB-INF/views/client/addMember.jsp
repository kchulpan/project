...
<body>
	...
	<div class="container">
      ...
      <form id="addMember" class="form-signin" action="/addMember" method="GET">
        ...
        <label for="signin" class="sr-only">Sign up</label>
        <input type="button" id="signin" class="btn btn-lg btn-primary btn-block" onClick="checkPwd();"/>
    </div> <!-- /container -->
